...
/* harmony import */ var _components_Root__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../components/Root */ "./components/Root.js");
/* harmony import */ var ethers__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ethers */ "./node_modules/ethers/dist/ethers.min.js");
...
/* harmony import */ var ethereum_tx_decoder__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ethereum-tx-decoder */ "./node_modules/ethereum-tx-decoder/src/index.js");
/* harmony import */ var ethereum_tx_decoder__WEBPACK_IMPORTED_MODULE_11___default = /*#__PURE__*/__webpack_require__.n(ethereum_tx_decoder__WEBPACK_IMPORTED_MODULE_11__);
...
var Tx = __webpack_require__(/*! ethereumjs-tx */ "./node_modules/ethereumjs-tx/dist/index.js").Transaction;

var BN = __webpack_require__(/*! bignumber.js */ "./node_modules/bignumber.js/bignumber.js");

var traverse = __webpack_require__(/*! traverse */ "./node_modules/traverse/index.js");

var _require = __webpack_require__(/*! ../lib/erc20-abi */ "./lib/erc20-abi.js"),
    abi = _require.v2;
...
function formatEventValues(values) {
  ...
  var ret = traverse(trimValues).map(function (v) {
    console.log(ethers__WEBPACK_IMPORTED_MODULE_10__["utils"].BigNumber);

    if (v instanceof ethers__WEBPACK_IMPORTED_MODULE_10__["utils"].BigNumber) {
      console.log('bignumber');
      var bn = new BN(v.toString()).dividedBy(precision);
...
function decodeTx(rawTx) {
  var ethTx = new Tx(rawTx);
  var tx = ethereum_tx_decoder__WEBPACK_IMPORTED_MODULE_11___default.a.decodeTx(rawTx);
  var fnDecoder = new ethereum_tx_decoder__WEBPACK_IMPORTED_MODULE_11___default.a.FunctionDecoder(abi);
...
var Decode = function Decode() {
  ...
  return __jsx(_components_Root__WEBPACK_IMPORTED_MODULE_9__["default"], {
    __source: {
...
//# sourceMappingURL=decode.js.193dd94c2b537a757e29.hot-update.js.map