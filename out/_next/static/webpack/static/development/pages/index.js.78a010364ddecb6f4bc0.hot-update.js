...
function validSeedOrPrivKey(seedOrPrivKey) {
  return /^(?:0x)?[0-9a-fA-F]{64}$/.test(seedOrPrivKey) || seedOrPrivKey.split(' ').length === 12;
}
function decodeSeed(seedOrPrivKey, idx) {
  ...
  try {
    if (!/^(?:0x)?[0-9a-fA-F]{64}$/.test(seedOrPrivKey)) {
      ...
      privKey = Object(ethereumjs_util__WEBPACK_IMPORTED_MODULE_4__["addHexPrefix"])(seedOrPrivKey);
    }
...
//# sourceMappingURL=index.js.78a010364ddecb6f4bc0.hot-update.js.map