...
/* harmony import */ var _components_Root__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../components/Root */ "./components/Root.js");
/* harmony import */ var ethers__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ethers */ "./node_modules/ethers/dist/ethers.min.js");
...
/* harmony import */ var ethereum_tx_decoder__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ethereum-tx-decoder */ "./node_modules/ethereum-tx-decoder/src/index.js");
/* harmony import */ var ethereum_tx_decoder__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(ethereum_tx_decoder__WEBPACK_IMPORTED_MODULE_9__);
...
/* harmony import */ var traverse__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! traverse */ "./node_modules/traverse/index.js");
/* harmony import */ var traverse__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(traverse__WEBPACK_IMPORTED_MODULE_12__);
...
function formatEventValues(values) {
  ...
  var ret = traverse__WEBPACK_IMPORTED_MODULE_12___default()(trimValues).map(function (v) {
    if (v instanceof ethers__WEBPACK_IMPORTED_MODULE_8__["utils"].BigNumber) {
      console.log('bignumber');
      var bn = new bignumber_js__WEBPACK_IMPORTED_MODULE_11___default.a(v.toString()).dividedBy(precision);
...
function decodeTx(rawTx) {
  var ethTx = new ethereumjs_tx__WEBPACK_IMPORTED_MODULE_10__["Transaction"](rawTx);
  var tx = ethereum_tx_decoder__WEBPACK_IMPORTED_MODULE_9___default.a.decodeTx(rawTx);
  var fnDecoder = new ethereum_tx_decoder__WEBPACK_IMPORTED_MODULE_9___default.a.FunctionDecoder(_lib_erc20_abi__WEBPACK_IMPORTED_MODULE_13__["v2"]);
...
var Decode = function Decode() {
  ...
  return __jsx(_components_Root__WEBPACK_IMPORTED_MODULE_7__["default"], {
    __source: {
...
//# sourceMappingURL=decode.js.8e05968e8405c41a6b8e.hot-update.js.map